# **任意精度浮動小数点演算ライブラリver0.3.0 使い方**
諸般の事情でコードの保守ができなくなりましたのでアーカイブされます。
...
## 免責事項
 - このプログラムを使用したことによる損害の発生は一切保証しません。
 - このプログラムは趣味で作っているものでありバグが多く含まれる可能性があります。自己責任でご使用ください。

## 更新履歴
 - v0.3.0 バグ修正、pow関数のb引数のマイナスの対応。
